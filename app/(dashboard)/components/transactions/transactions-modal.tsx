    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Verify Transactions">
            <div className="flex gap-6">
                <div>
                    <h4 className="font-semibold text-xm mb-2">payment Proof</h4>
                ...
                <div>
                    ...
                    <div className="bg-gray-100 rounded-md flex flex-col gap-2.5 p-4 text-xm mb-5">
                    ...
                    <h4 className="font-semibold text-xm mb-2">Items Purchased</h4>
                    <div className="border border-gray-200 rounded-lg p-2 flex items-center gap-2">
                        ...
                        <div className="font-medium text-xm">SportsOn Hyperfast Shoes</div>
                        <div className="font-medium ml-auto text-xm">3 units</div>
                    </div>
                    <div className="flex justify-between text-xm mt-6">
