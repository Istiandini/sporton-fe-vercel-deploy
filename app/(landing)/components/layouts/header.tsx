...
const Header = () => {
    ...
    return (
        <header className="fixed w-full z-20 bakcdrop-blur-xl bg-white/50">
            <div className="flex justify-between gap-10 container mx-auto py-7">
                ...
                <div className="relative flex gap-10">
                    ...
                    <button className="relative cursor-pointer" onClick={() => setIsCartPopupOpen(!isCartPopupOpen)}>
                        ...
                        {items.length ? (
                            <div className="bg-primary rounded-full w-3.5 absolute -top-1 -right-1 text-[10px] text-white text-center">
                                {items.length}
                            </div>
                        ) : (
                            <></>
